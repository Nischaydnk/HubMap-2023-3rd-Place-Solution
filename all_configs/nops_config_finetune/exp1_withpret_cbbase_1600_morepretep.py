...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/home/nischay/hubmap/coco/ds1_coco_1024_train_all_fold5.json',
    ...
    val=dict(
        type='CocoDataset',
        classes=('blood_vessels', ),
        ann_file='/home/nischay/hubmap/coco/ds1_coco_1024_valid_all_fold5.json',
        img_prefix='/home/nischay/hubmap/Data/train/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    test=dict(
        ...
        classes=('blood_vessels', ),
        ann_file=
        '/home/nischay/hubmap/coco/ds12_coco_1024_valid_all_fold5.json',
        img_prefix='/home/nischay/hubmap/Data/train/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
log_level = 'INFO'
load_from = '/home/nischay/hubmap/try_mm/mmdetection/cbnet/work_dirs/hubmap/pretexp1_cbnetbase_1600_10e/detectors_epoch_10.pth'
work_dir = './work_dirs/hubmap/exp1_withpret_cbbase_1600_morepretep/fold5'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
