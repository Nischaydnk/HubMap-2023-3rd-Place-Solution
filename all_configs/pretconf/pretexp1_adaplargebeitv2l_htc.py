NUM_CLASSES = 1
drop_path_rate = 0.25 # 0.4 (pre-train) -> 0.3 (fine-tune)
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/home/nischay/hubmap/pseudo/50_combined_ds2wsiall_exp2pseudo.json',
...
work_dir = './pret_dir/ps50exp2_exp3_adaplargebeitv2lhtc_1500_ds2wsiall'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
