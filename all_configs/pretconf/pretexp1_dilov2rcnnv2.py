...
# optimizer = dict(type='SGD', lr=0.007, momentum=0.9, weight_decay=0.00001,
                   # )
...
log_level = 'INFO'
load_from = '/home/nischay/hubmap/vitadap/detection/mask_rcnn_augreg_adapter_large_fpn_3x_coco.pth'
work_dir = './pret_dir/exp2_ds1only_augreglargemaskrcnn_1400_pret'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
