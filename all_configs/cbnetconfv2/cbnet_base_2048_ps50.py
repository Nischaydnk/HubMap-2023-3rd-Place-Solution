...
data = dict(
    ...
    train=dict(
        ...
        ann_file=
        '/home/nischay/hubmap/coco/ds1_coco_1024_train_all_fold1.json',
...
log_level = 'INFO'
load_from = '/home/nischay/hubmap/vitadap/detection/work_dirs/pret/ps50exp2_cbnetbase_1600_10e/best_segm_mAP_epoch_10.pth'
work_dir = './work_dirs/hubmap/exp3_withpret_cbbase_1600_morepretep_ps50exp2'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
