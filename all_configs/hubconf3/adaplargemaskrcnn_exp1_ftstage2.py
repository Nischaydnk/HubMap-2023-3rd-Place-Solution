...
log_level = 'INFO'
load_from = '/home/nischay/hubmap/vitadap/detection/pret_dir/pretexp3_ds2only_augreglargemaskrcnn_1024_pret/best_segm_mAP_epoch_9.pth'
work_dir = './work_dir/stage2exp4_augreglargemaskrcnn_1200_pret_ps60'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
