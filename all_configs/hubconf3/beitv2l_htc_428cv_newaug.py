    ...
    roi_head=dict(
        ...
        mask_head=[
            dict(
                ...
                num_classes=1,
                loss_mask=dict(
                    type='CrossEntropyLoss', use_mask=True, loss_weight=1.4)),
            dict(
                type='HTCMaskHead',
                num_convs=4,
                in_channels=256,
...
log_level = 'INFO'
load_from = '/home/nischay/hubmap/vitadap/detection/pret_dir/ps50exp2_exp3_adaplargebeitv2lhtc_1500_ds2wsiall/detectors_epoch_8.pth'
work_dir = './work_dirs/pretexp11_adapbeitv2lhtc_1400_ds2wsiall'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
