...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/home/nischay/hubmap/coco/ds1_coco_1024_train_full_fold1.json',
...
log_level = 'INFO'
load_from = '/home/nischay/hubmap/vitadap/detection/pret_dir/exp3_adaplargebeitv2lhtc_1200_ds2wsiall/detectors_epoch_10.pth'
work_dir = './work_dirs/pretexp4_adapbeitv2lhtc_1400_ds2wsiall_ps60exp2_lossw2_adamp2_leak/f0'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
