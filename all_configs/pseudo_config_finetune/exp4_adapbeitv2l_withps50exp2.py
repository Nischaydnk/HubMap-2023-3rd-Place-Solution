...
log_level = 'INFO'
load_from = '/home/nischay/hubmap/vitadap/detection/pret_dir/ps50exp2_exp3_adaplargebeitv2lhtc_1200_ds2wsiall/best_segm_mAP_epoch_8.pth'
work_dir = './work_dirs/pretexp4_adapbeitv2lhtc_1400_ds2wsiall_ps50exp2_lossw2/f0'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
