...
data = dict(
    ...
    train=dict(
        ...
        ann_file=
        '/home/nischay/hubmap/pseudo/50_combined_ds2wsiall_exp2pseudo.json',
...
log_level = 'INFO'
load_from = '/home/nischay/hubmap/vitadap/detection/htc_cbv2_swin_large22k_patch4_window7_mstrain_400-1400_giou_4conv1f_adamw_1x_coco.pth'
work_dir = './work_dirs/pret/ps50exp2_cbnetlarge_1600_8e'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
