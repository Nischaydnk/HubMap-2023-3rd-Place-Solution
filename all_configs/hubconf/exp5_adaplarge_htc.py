...
log_level = 'INFO'
load_from = '/home/nischay/hubmap/vitadap/detection/pret_dir/exp3_adaplargebeithtc_1200_ds2wsiall/best_segm_mAP_epoch_7.pth'
work_dir = './work_dirs/pretexp4_adaplargehtc_1400_bs2_augv4_leaky'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
