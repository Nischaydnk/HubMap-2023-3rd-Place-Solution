...
log_level = 'INFO'
load_from = '/home/nischay/hubmap/vitadap/detection/pret_dir/exp3_adaplargebeithtc_1200_ds2wsiall/best_segm_mAP_epoch_7.pth' #'/home/nischay/hubmap/vitadap/detection/htc++_beit_adapter_large_fpn_3x_coco.pth.tar'
work_dir = './work_dirs/pretexp5_adaplargehtc_1200_bs2_augv4'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
