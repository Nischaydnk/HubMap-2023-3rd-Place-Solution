...
data = dict(
    ...
    train=dict(
        ...
        ann_file='/home/nischay/hubmap/cocov2/ds1all_coco_1024_train_all_fold1.json',
    ...
    val=dict(
        type='CocoDataset',
        classes=('blood_vessels', ),
        ann_file='/home/nischay/hubmap/cocov2/ds12all_coco_1024_valid_all_fold1.json',
        img_prefix='/home/nischay/hubmap/Data/train/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    test=dict(
        ...
        classes=('blood_vessels', ),
        ann_file=
        '/home/nischay/hubmap/cocov2/ds12all_coco_1024_valid_all_fold1.json',
        img_prefix='/home/nischay/hubmap/Data/train/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
optimizer = dict(type='SGD', lr=0.035, momentum=0.9, weight_decay=0.001,
                                 constructor='LayerDecayOptimizerConstructor',
                 paramwise_cfg=dict(num_layers=24, layer_decay_rate=0.965)
                    )
...
work_dir = './dir_noleak/pretexp9_adapbeitv2lhtc_1400_ds2wsiall'
workflow = [('train', 1)]
auto_resume = False
resume_from = None
launcher = 'none'
